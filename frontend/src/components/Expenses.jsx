...
const Expenses = () => {
    ...
    return (
        <section className={`mb-20 min-h-max flex-col  ${internalActiveSection === "Expenses" ? "flex" : "hidden"}`}>            <div className="w-full h-screen bg-gray-50 p-8">
                ...
                {expenses.length > 0 ? (
                    <ul className="space-y-4 flex flex-wrap px-5 justify-between gap-5">
                        {expenses.map((expense, index) => {
                            ...
                            return (
                                <li key={expense._id || index} className="flex justify-between min-w-100 items-center hover:bg-gray-50 shadow-sm rounded-lg p-2 transition">
